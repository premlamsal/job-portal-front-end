...
<style lang="scss">
// @import url("http://fonts.cdnfonts.com/css/homizio");
// @import url("http://fonts.cdnfonts.com/css/levenim-mt");
@import url("https://fonts.cdnfonts.com/css/foco");
// @import url("http://fonts.cdnfonts.com/css/futura-lt-bt");
// @import url("http://fonts.cdnfonts.com/css/leelawadee");
#app {
  font-size: 16px;
  // font-family: 'Homizio', sans-serif;
