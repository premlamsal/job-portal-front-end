...
<span>{{dashInfo.appliedJobs}}</span>
                    </h2>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 col-xl-3">
                <div class="card bg-c-yellow order-card">
                  <div class="card-block">
                    <h6 class="m-b-20">Matching Jobs</h6>
                    <h2 class="text-right">
                                                               <b-icon icon="intersect" class="f-left"></b-icon>
<span>{{dashInfo.matchedJobs}}</span>
                    </h2>
                  </div>
                </div>
              </div>
...
export default {
  name: "JobSeekerDashboardPanel",
  tittle: "Dashboard JobSeeker |Job Malai",
  data() {
    return {
      dashInfo:{
      },
  ...
  methods: {
     getDashInfo(){
       ...
       this.$http.get('jobseeker/dash-info')
       .then((response)=>{
